...
export function newToggleArticlePublic() {
    return { type: NEW_TOGGLE_ARTICLE_PUBLIC };
}

export function editToggleArticlePublic() {
    return { type: EDIT_TOGGLE_ARTICLE_PUBLIC };
}