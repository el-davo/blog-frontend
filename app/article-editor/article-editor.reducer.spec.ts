...
describe('Article Viewer Reducer', () => {
  ...
  describe('UPDATE_EDIT_ARTICLE', () => {
    ...
    it('should display the article that we are editing', () => {
      ...
      articleEditorReducer(state, action).should.eql({
        ...state,
  ...
  describe('EDIT_KEY_ARTICLE_NAME', () => {
    ...
    it('should add a new character to the end of the string', () => {
      ...
      const state = {
        ...articleEditor,
        editingArticle: {...articleEditor.editingArticle, name: ''}
      } as ArticleEditorState;

      articleEditorReducer(state, action).should.eql({
        ...state,
        editingArticle: {...state.editingArticle, name: 'potato'}
      });
    });
  });
  ...
  describe('EDIT_KEY_ARTICLE_SUMMARY', () => {
    ...
    it('should add a new character to the end of the string', () => {
      ...
      const state = {
        ...articleEditor,
        editingArticle: {...articleEditor.editingArticle, summary: ''}
      } as ArticleEditorState;

      articleEditorReducer(state, action).should.eql({
        ...state,
        editingArticle: {...state.editingArticle, summary: 'potato'}
      });
    });
  });
  ...
  describe('EDIT_KEY_ARTICLE_CONTENT', () => {
    ...
    it('should add a new character to the end of the string', () => {
      ...
      const state = {
        ...articleEditor,
        editingArticle: {...articleEditor.editingArticle, content: ''}
      } as ArticleEditorState;

      articleEditorReducer(state, action).should.eql({
        ...state,
        editingArticle: {...state.editingArticle, content: 'potato'}
      });
    });
  });
  ...
  describe('EDIT_KEY_ARTICLE_IMG', () => {
    ...
    it('should add a new character to the end of the string', () => {
      ...
      const state = {
        ...articleEditor,
        editingArticle: {...articleEditor.editingArticle, imgUrl: ''}
      } as ArticleEditorState;

      articleEditorReducer(state, action).should.eql({
        ...state,
        editingArticle: {...state.editingArticle, imgUrl: 'potato'}
      });
    });
  });
  ...
  describe('NEW_TOGGLE_ARTICLE_PUBLIC', () => {
    ...
    it('should toggle the public state of the new article', () => {
      ...
      articleEditorReducer(offState, action).should.eql({
        ...offState,
        newArticle: {public: true}
      } as ArticleEditorState);
  ...
  describe('EDIT_TOGGLE_ARTICLE_PUBLIC', () => {
    ...
    it('should toggle the public state of the new article', () => {
      ...
      articleEditorReducer(offState, action).should.eql({
        ...offState,
        editingArticle: {public: true}
      } as ArticleEditorState);
      articleEditorReducer(onState, action).should.eql({
        ...onState,
        editingArticle: {public: false}
      } as ArticleEditorState);
    });
  });
