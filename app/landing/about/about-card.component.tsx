    ...
    render() {
        return (
            <div>
                ...
                <Card>
                    <CardContent>
                        <Typography type="headline">About el-davo</Typography>
                        ...
                        so i thought it was about time I start sharing some of my knowledge in the hope it might help
                        some
                        young up and coming software developers. My current main two languages of choice are
                        Javascript and Java. This website is built with react for the frontend and nodejs for the
                        backend.
                        You will find some articles that might interest you below, thanks for stopping by and if you
                        want to
