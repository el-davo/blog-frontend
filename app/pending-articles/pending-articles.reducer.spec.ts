...
describe('Pending Articles Reducer', () => {
    ...
    describe('FETCH_PENDING_ARTICLES', () => {
        ...
        it('should fetch a list of articles', () => {
            ...
            pendingArticlesReducer(state, action).should.eql({ ...state, isFetchingPendingArticles: true } as PendingArticlesState);
        });
    });
    ...
    describe('FETCH_PENDING_ARTICLES_FAILED', () => {
        ...
        it('should inform the user that the fetch has failed', () => {
            ...
            pendingArticlesReducer(state, action).should.eql({ ...state, isFetchingPendingArticles: false } as PendingArticlesState);
        });
    });
});